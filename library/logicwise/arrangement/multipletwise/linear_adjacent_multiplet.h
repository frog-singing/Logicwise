...
namespace logicwise::detail
{
	...
	template<> struct linear_adjacent_multiplet_impl<0> { using type = multipletwise_void; };
	template<> struct linear_adjacent_multiplet_impl<1> { using type = multipletwise_element; };
