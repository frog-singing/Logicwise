...
| 值列表		| 所有模板参数都是值的类实例	| value_list<true, 2, 3.0, '4'> | std\::make_index_sequence<4> <br> *因为该别名的实际类型为： <br> std\::integer_sequence<std::size_t, 0, 1, 2, 3>， <br> 第一位参数并非值* |
...
#### [占位符](test/mode/validation/elementwise.cpp)
